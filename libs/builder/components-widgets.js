...
Vvveb.Components.extend("_base", "widgets/googlemaps", {
  ...
  init: function (node) {
    ...
    document.querySelector(".component-properties input[name=z]").value =
      this.z;
    document.querySelector(".component-properties input[name=q]").value =
      this.q;
    document.querySelector(".component-properties select[name=t]").value =
      this.t;
    document.querySelector(".component-properties input[name=key]").value =
      this.key;
  },
...
Vvveb.Components.extend("_base", "widgets/openstreetmap", {
  ...
  init: function (node) {
    ...
    document.querySelector(".component-properties input[name=bbox]").value =
      this.bbox;
    document.querySelector(".component-properties input[name=layer]").value =
      this.layer;
  },
...
Vvveb.Components.extend("_base", "widgets/embed-video", {
  ...
  init: function (node) {
    ...
    document.querySelector(".component-properties input[name=video_id]").value =
      this.video_id;
    document.querySelector(".component-properties input[name=url]").value =
      this.url;
    document.querySelector(".component-properties select[name=t]").value =
      this.t;
  },
      ...
      onChange: function (node, value, input, component) {
        ...
        if (
          ...
          document.querySelector(".component-properties select[name=t]").value =
            t;
          document.querySelector(
            ".component-properties select[name=video_id]"
          ).value = id[1];
